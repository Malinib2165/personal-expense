...
const SetAvatar = () => {
  ...
  const setProfilePicture = async () => {
    ...
    try {
      ...
      if (!user?._id) {
        toast.error("User not found in localStorage. Please login again.", toastOptions);
        return;
      }
      ...
      toast.error(typeof message === "string" ? message : "Error Setting avatar. Please Try again", toastOptions);
